...
import { FormField } from "../platform/forms/field.ts";
...
export class AppViewModel extends EventTarget implements ViewModelLifecycle {
  ...
  @rx.push accessor draftText: FormField;
  @rx.push accessor connectionAddress: FormField;
  @rx.push accessor client: LMStudioConnection | null;
  @rx.push accessor selectedModel: FormField;
  ...
  constructor() {
    ...
    this.conversation = [];
    this.connectionAddress = new FormField("http://192.168.10.3:1234");
    this.draftText = new FormField();
    this.selectedModel = new FormField();
